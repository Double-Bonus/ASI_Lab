...
[~,PSmapOut] = mapminmax(OUTdataTRAIN(1,:),-1,1);               % atliekam isejimo kintam?j? normavim?
...
Out_tikras=mapminmax('reverse',Out,PSmapOut);         % atliekam išejimo kintamuju atnormavima
